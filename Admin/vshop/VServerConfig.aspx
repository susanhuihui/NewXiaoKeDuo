<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.VServerConfig" CodeBehind="VServerConfig.aspx.cs" MasterPageFile="~/Admin/AdminNew.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function InitValidators() {
            initValid(new InputValidator('ctl00_ContentPlaceHolder1_txtSiteName', 1, 60, false, null, '店铺名称为必填项，长度限制在60字符以内'));
            initValid(new InputValidator('ctl00_ContentPlaceHolder1_txtSiteNamez', 1, 60, true, null, '长度限制在60字符以内'));
            initValid(new InputValidator('ctl00_ContentPlaceHolder1_txtregisterpoints', 1, 10, false, '-?[0-9]\\d*', '数据类型错误，只能输入整数型数值'))
            initValid(new InputValidator('ctl00_ContentPlaceHolder1_txtorderpoints', 1, 10, false, '-?[0-9]\\d*', '数据类型错误，只能输入整数型数值'))
        }
