    ...
    <asp:DataList ID="dlstVote" runat="server" Width="100%" DataKeyField="VoteId">
            ...
            <ItemTemplate>
              <tr>
                ...
                <td><span class="submit_bianji" style="width: 23px; float: left; padding-top: 6px;line-height: 23px;height: 23px;display:none">
                    <span id="spcopy<%#Container.ItemIndex+1 %>" title="复制"></span></span>
