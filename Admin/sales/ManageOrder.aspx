    ...
    <div class="dataarea mainwidth">
        ...
        <div class="datalist">
            <asp:DataList ID="dlstOrders" runat="server" DataKeyField="OrderId" Width="100%">
                <HeaderTemplate>
                    <table width="0" border="0" cellspacing="0">
                        <tr class="table_title">
                            ...
                            <td width="160px" class="td_right td_left">
                                订单状态
                            </td>
              ...
              <a style="color:Red;display:block;" href="javascript:DialogFrame('<%# "sales/SendOrderGoods.aspx?OrderId="+ Eval("OrderId") %>&reurl='+ encodeURIComponent(goUrl),'订单发货',null,null, function () { location.href=goUrl })">发货</a> </asp:Label>
                                ...
                                <a style="color: Red"></a><a href="javascript:;" onclick="return CheckRefund(this.title)"
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    <script src="../trade/order.helper.js" type="text/javascript"></script>
    <script type="text/javascript">
        var formtype = "";
