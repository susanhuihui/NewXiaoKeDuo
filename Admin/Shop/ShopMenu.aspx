...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        $(function () {
            ...
            $("#dropdow-menu-link  li[data-val='16']").remove();
                ...
                $.getJSON("../../API/MenuProcess.ashx?action=getmenu" + url).done(function (d) {
                    if (d.status == "0") {
                        ...
                        if ($.trim(data.shopmenupic) != "") {
                            $("#uploader1_upload").css("display", "none");
                            $("#uploader1_delete").css("display", "");
                            $("#uploader1_preview").append("<img src=\"" + data.shopmenupic + "\" id=\"uploader1_image\" style=\"width: 60px; height: 60px; background-color: rgb(255, 255, 255);\">");
            ...
            <div class="fl frwidth">
                <div class="set-switch">
                    ...
                    <asp:CheckBox ID="MemberDefault" runat="server" Text="会员中心" />&nbsp;&nbsp;
                        <asp:CheckBox ID="DistributorsMenu" runat="server" Text="分销商中心" />
                  <br />
                ...
                <script type="text/template" id="tabcontent">
                    <div id="panediv" class="tab-pane navgation">
                        <div class="tab-pane navgation" id="tabpane">
                            ...
                            <div class="shop-index clearfix"><span class="fl" id="fltitle">店铺主页</span><span class="fr"><span style="cursor: pointer;" id="EditMenu">编辑</span>&nbsp;<span id="spanhid">|&nbsp;设置二级导航以后，主链接已失效。</span></span></div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group" id="uploaderpic">
                                ...
                                <div class="col-xs-6">
                                    <Hi:UpImg runat="server" ID="uploader1" IsNeedThumbnail="false" UploadType="ShopMenu" UploadSize="10000" />
                                    <small class="help-block">建议尺寸：60 * 60像素，文件大小不超过10K</small>
                                </div>
