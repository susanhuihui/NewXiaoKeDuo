...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="col-xs-3">
                            <div class="shop-logo" style="position:relative">
                               <div id="divFileProgressContainer1"  style="float:left;border:1px solid #a19c9c;padding:2px"  > 
                                ...
                                <span  id="divFileProgressContainer" style="float:left"  > 
                                  
                                </span>
                                <span id="spanButtonPlaceholder">修改</span>
                                <div style="clear:both;color:#808080;font-size:12px;padding-top:10px">建议尺寸：200 x 200 像素<br />
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            function loader(url) {
                var settings = {
                    upload_url: "../distributor/DistributorLogoUpload.aspx",
                    post_params: {
                        imgurl: url
                    },
        ...
        function uploadSuss(file, serverData) {
            try {
                ...
                if (serverData != "0") {
                    ...
                    setTimeout(function () { HiTipsShow("店铺LOGO修改成功！", "success") }, 300);
                }
                else {
                    alert("图片上传最多1张！");
                }
        ...
        function InitValidators() {
            ...
            $('#aspnetForm').formvalidation({
                'ctl00$ContentPlaceHolder1$txtSiteName': {
                    validators: {
                        notEmpty: {
                            message: '请填写您的店铺名称，长度在30个字符以内'
                        },
                        stringLength: {
                            min: 1,
                            max: 30,
                            message: '店铺名称的长度不能超过30个字符'
                        }
                    }
                },
