            ...
            <div role="tabpanel" class="exitshopinfo" style="background-color:#fff;" id="setting">                    
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-5">           
                        ...
                        <button type="button" class="btn btn-default"  onclick="window.open('http://meiqia-cdn.b0.upaiyun.com/meiqia_for_android.apk')">Android版</button>
                    </div>                          
                </div>                                
            </div>
            <div class="exitshopinfo maind" style="background-color:#fff;<%=enable ? "" : "display:none" %>">
                ...
                <div class="form-group">
                    <div class="col-xs-offset-2">
                        <asp:Button runat="server" CssClass="btn btn-success bigsize" Text="开通主帐号" ID="OpenAccount" OnClick="OpenAccount_Click" OnClientClick="return beforeSaveData(this)" />
