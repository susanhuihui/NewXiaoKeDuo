    ...
    <form id="thisForm" runat="server" class="form-horizontal">
        ...
        <div style="margin-left:-130px;">
            <div class="form-group">
                ...
                <div class="col-xs-4">
                    <Hi:ImageDataGradeDropDownList ID="dropImageFtp" CssClass="form-control resetSize" runat="server" />
                </div>
            </div>
        </div>
...
<%--                    <td>
                        <table cellpadding="0" cellspacing="5" id="ImagesFtp" class="ImagesFtp">
                            <tr>--%>
                                ...
                                <td width="60" nowrap="nowrap"><a onclick="AddAttachment()" href="javascript:void(0)" class="add">添加</a></td>
                            <%--</tr>--%>
                        <%--</table>
