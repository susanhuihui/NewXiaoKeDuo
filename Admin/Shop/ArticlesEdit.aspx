...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btn-save").click(function () {
                ...
                $.ajax({
                    ...
                    type: "post",
                    data: "posttype=addsinglearticle&linkType="+encodeURIComponent(linkType)+"&linkUrl=" + encodeURIComponent(linkUrl) + "&title=" + encodeURIComponent(title) + "&img=" + encodeURIComponent(img) + "&memo=" +encodeURIComponent(memo)+ "&content=" +encodeURIComponent(content),
                    datatype: "json",
        ...
        function syncAbstract(value) {
            ...
            $("#digest").val(getStrbylen(value,255));
        }
    </script>
</asp:Content>
            ...
            <div class="edit-text-right" id="box_move">
                <div class="edit-inner">
                    <div class="form-group">
                        ...
                        <small class="help-block">建议不大于30个字</small>
                    </div>
                    <div class="form-group">
                        ...
                        <small class="help-block inline">建议尺寸：900×500像素，小于200KB，支持.jpg、.gif、.png格式</small>
                    </div>
