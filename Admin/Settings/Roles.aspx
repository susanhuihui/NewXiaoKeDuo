...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="thisForm" runat="server" style="margin-top:20px">
        <ui:grid ID="grdGroupList" runat="server" AutoGenerateColumns="false" ShowHeader="true" DataKeyNames="RoleId" CssClass="table table-hover mar table-bordered"  GridLines="None" HeaderStyle-CssClass="table_title" >    
                       <Columns>
                            <asp:TemplateField HeaderText="部门名称" HeaderStyle-CssClass="td_right td_left">
                             ...
                             <asp:TemplateField HeaderText="职能说明" ItemStyle-Width="50%" ItemStyle-CssClass="tdleft"  HeaderStyle-CssClass="td_right td_left">
                                  <ItemTemplate>
                                   <div class="tdleft"><asp:Literal ID="lblRoleDesc" Text='<%#Eval("Description") %>' runat="server"></asp:Literal></div> 
                                  </ItemTemplate>                                 
                             </asp:TemplateField>
  ...
  <div class="modal-dialog">
    <div class="modal-content form-horizontal"  id="hform">
     ...
     <div class="form-group">
         ...
         <div class="col-xs-3" style="width:72%"><asp:TextBox ID="txtAddRoleName" runat="server" CssClass="form-control"  Width="300px"></asp:TextBox>
     ...
     <div class="form-group">
          <label  for="inputEmail3" class="col-xs-2 control-label" >职能说明：</label>
             <div class="col-xs-3" style="width:72%" ><asp:TextBox ID="txtRoleDesc" runat="server" CssClass="form-control"  Height="81px" TextMode="MultiLine" Width="300px"></asp:TextBox>
