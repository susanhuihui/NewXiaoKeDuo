       ...
       <div >
           ...
           <div class="shipperBox">
               ...
               <div class="shipperBtn">
                   ...
                   <asp:LinkButton ID="LBtnDel"  CssClass="btn btn-danger btn-xs"  OnClientClick="return   confirm('确定要删除？删除后将不可恢复。');" runat="server" OnClick="DeleteShiper" CommandArgument='<%#Eval("ShipperId") %>'  >删除</asp:LinkButton>
               </div>
                   <%#Eval("TelPhone") %></div>
