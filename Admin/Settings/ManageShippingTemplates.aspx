                        ...
                        <tbody>
                           ...
                           <asp:Repeater runat="server" ID="ListShipper">
                              <HeaderTemplate>
                                ...
                                <th width="100">首件(<%# SettingsHelper.getMUnitText((int)DataBinder.Eval((Container.Parent.Parent as RepeaterItem).DataItem, "MUnit")) %>)</th>
                                <th width="100">运费</th>
