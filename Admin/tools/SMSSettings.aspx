<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" 
    AutoEventWireup="true" CodeBehind="SMSSettings.aspx.cs" Inherits="Hidistro.UI.Web.Admin.tools.SMSSettings" %>
            ...
            <div id="maindiv"  >
                ...
                <div class="form-group">
                    <div class="col-xs-offset-2">
                        <asp:Button runat="server" class="btn btn-success bigsize" ID="btnSaveSMSSettings" Text="保存" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="inputEmail3" class="col-xs-2 control-label">发送内容：</label>
                    <div class="col-xs-4">
                ...
                <div class="form-group">
                    <div class="col-xs-offset-2">
                        ...
                        <asp:Button runat="server" class="btn btn-success bigsize" ID="btnTestSend" OnClientClick="return TestCheck();"  Text="发送" />
                    </div>
                </div>
            </div>
        </div>
