                    ...
                    <UI:Grid ID="grdConsultation" runat="server" ShowHeader="true" CssClass="table mar table-bordered midclass"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="商品" ItemStyle-Width="30%" HeaderStyle-CssClass="td_left td_right_fff">
                                ...
                                <ItemTemplate >
                                    <a href='<%#string.Format("../../ProductDetails.aspx?productId={0}",Eval("productId"))%>'
                            ...
                            <asp:TemplateField HeaderText="客户评论" HeaderStyle-CssClass="td_left td_right_fff">
                                <ItemTemplate>
                                    <div>
                            ...
                            <asp:TemplateField HeaderText="操作" ItemStyle-Width="60" HeaderStyle-CssClass="td_left td_right_fff" >
                                <ItemTemplate>
                                    ...
                                    <span class="submit_fuihu"><a href="javascript:void(0);" onclick="showModel('<%#Eval("ConsultationId")%>')"
                                        class="btn btn-success resetSize">回复</a></span>
                                    <span class="submit_shanchu">
                                        <Hi:ImageLinkButton ID="ilikbReplyDelete" runat="server" CommandName="Delete" IsShow="true"
                                            CommandArgument='<%# Eval("ConsultationId")%>' OnClientClick="" Text="删除" CssClass="btn btn-danger resetSize" />
                                    </span>
