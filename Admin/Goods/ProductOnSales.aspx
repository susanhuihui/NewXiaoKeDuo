    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(window).scroll(function () {
                ...
                if($('body').scrollTop()+$('.title-table').height()+58 <= tableTitle){
                    ...
                    <div class="set-switch">
                        <div class="form-inline mb10">
                            ...
                            <div class="form-group mr20">
                                ...
                                <Hi:ProductCategoriesDropDownList ID="dropCategories" CssClass="form-control resetSize inputw100" runat="server" NullToDisplay="请选择商品分类"
                                    Width="150" />
                            </div>
                            <div class="form-group">
                                    ...
                                    <tr>
                                        <td colspan="8">
                                            <div class="mb10 table-operation">
                                                ...
                                                <Hi:ImageLinkButton ID="btnDelete" class="btn resetSize btn-danger" runat="server"
                                                    Text="删除" IsShow="true" DeleteMsg="确定要把商品移入回收站吗？分销商的相关商品也将被删除！" />
                                                &nbsp;︱
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td width="7%">
                                                    ...
                                                    <p>
                                                        <Hi:ImageLinkButton ID="ImageLinkButton1" CommandName="UnSaleProduct" CommandArgument='<%# Eval("ProductId") %>' runat="server" Text="下架" IsShow="true"
                                                            DeleteMsg="确定要入库商品？入库后商品将不在前台显示" />︱ 
                                                        <Hi:ImageLinkButton ID="btnDel" CommandName="Delete" CommandArgument='<%# Eval("ProductId") %>'
                                                            runat="server" Text="删除" IsShow="true"
                                                            DeleteMsg="确定要把商品移入回收站吗？分销商的相关商品也将被删除！" />
                                                    </p>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                ...
                                <div class="modal-body">
                                    <div class="form-inline">
                                        <div class="form-group mr20">
                                            ...
                                            <Hi:FreightTemplateDownList ID="FreightTemplateDownList1" CssClass="form-control inputw100" runat="server" NullToDisplay="--请选择运费模板--"
                                                Width="180" />
                                        </div>
