...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        #attributeContent li:after{display:block;height:0;content:"";clear:both;}
        #attributeContent li{clear:both;display:block;margin-bottom:5px;}
        #attributeContent li select{margin-right:5px;}
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane <%if (isnext != 1)
                    ...
                    <div class="exitshopinfo resize">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <Hi:TrimTextBox runat="server" CssClass="form-control" ID="txtMarketPrice" />&nbsp;&nbsp;元
                                </div>
                            </div>
                            <div class="form-group" id="salePriceRow">
                                <label for="input2" class="col-xs-2 control-label"><em>*</em>现价：</label>
                                <div class="col-xs-4">
                                    <Hi:TrimTextBox runat="server" CssClass="form-control" ID="txtSalePrice" />&nbsp;&nbsp;元
                            ...
                            <div class="form-group" id="skuCodeRow"  >
                                ...
                                <div class="col-xs-4">
                                    ...
                                    <span style="display:none"><Hi:TrimTextBox runat="server" CssClass="form-control" ID="txtSku"   /></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="display: <%=(productId>0?"none":"block")%>">
                                ...
                                <div class="col-xs-4">
                                    <Hi:TrimTextBox runat="server" CssClass="form-control" ID="txtShowSaleCounts" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="exitshopinfo resize">
                        <div class="form-horizontal">
                            ...
                            <div class="clearfix" id="l_tags" runat="server" style="display: none;">
                ...
                <div role="tabpanel" class="tab-pane <%if (isnext == 1)
                    ...
                    <div class="footer-btn navbar-fixed-bottom">
                        <button type="button" class="btn btn-primary" onclick="$('#myTab li:eq(1) a').tab('show');">上一步</button>
