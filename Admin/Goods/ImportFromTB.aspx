            ...
            <div class="tab-content">
                <div class="tab-pane active">
                    <div class="set-switch">
                        <strong>数据包信息</strong>
                        <p>淘宝数据包的来源：1.销客多系统本身导出的淘宝数据包；2.淘宝或商品助理导出的文件，把CSV文件和图片文件夹都命名为products然后选中两个打成zip的压缩包</p>
                    </div>
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label for="" class="col-xs-2 control-label">导入插件版本</label>
                            <div class="col-xs-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-4">
                                ...
                                <small class="help-block">导入之前需要先将数据包文件上传到服务器上；<br />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-4">
                                <asp:FileUpload runat="server" ID="fileUploader" CssClass="form-control" />
                                 <small class="help-block">上传数据包须小于40M，否则可能上传失败，<br />
                                     您还可以使用FTP工具先将数据包上传到网站的/storage/data/taobao目录以后，
                                     再重新打开此页面操作。</small>
                            </div>
