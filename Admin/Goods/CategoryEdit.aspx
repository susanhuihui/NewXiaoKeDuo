            ...
            $('#aspnetForm').formvalidation({
                ...
                'ctl00$ContentPlaceHolder1$txtSKUPrefix': {
                    validators: {
                        regexp: {
                            regexp: /^(?!_)(?!-)[a-zA-Z0-9_-]+$/,
                            message: '货号前缀长度限制在5个字符以内，前缀只能是字母数字-和_'
                        }
                    }
                },
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <asp:TextBox ID="txtCategoryName" runat="server" CssClass="form-control inputw200" MaxLength="60" />
                    ...
                    <div class="form-group">
                        <label class="col-xs-2 control-label">货号前缀</label>
                        <div class="col-xs-6">
                            <asp:TextBox ID="txtSKUPrefix" runat="server" CssClass="form-control inputw200" MaxLength="5" />
                            <small class="help-block">填写以后，发布商品为您自动生成货号的时候可以加上此前缀，只能是字母、数字、-(减号)、_(下划线)，长度5个字符以内</small>
                        </div>
                    </div>
        ...
        <div class="exitshopinfo resize bg" style="display:<%=(categoryid>0||dropCategories.SelectedValue>0)?"none":"block"%>">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <asp:TextBox ID="txtthird" runat="server" CssClass="form-control inputw200" MaxLength="5"/>&nbsp;&nbsp;%
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="input7" class="col-xs-2 control-label"><em>*</em>上一级佣金比例：</label>
                                <div class="col-xs-4">
                                    <asp:TextBox ID="txtsecond" runat="server" CssClass="form-control inputw200" MaxLength="5"/>&nbsp;&nbsp;%
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="input8" class="col-xs-2 control-label"><em>*</em>成交店铺佣金比例：</label>
                                <div class="col-xs-4">
                                    <asp:TextBox ID="txtfirst" runat="server" CssClass="form-control inputw200" MaxLength="5"/>&nbsp;&nbsp;%
                                </div>
                            </div>
                        </div>
                    </div>
               ...
               <div style="display:none" class="m_none"><span class="formitemtitle Pw_100">分类广告：</span>
                    <span class="tab">
					<div class="status">
					    <ul>
