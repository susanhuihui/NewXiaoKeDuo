    ...
    <form runat="server" style="width:650px;">
        ...
        <div class="set-switch">
            <div class="form-inline mb10">
                <div class="form-group mr20">
                    ...
                    <asp:TextBox ID="txtPrefix" runat="server" Width="80px" MaxLength="20" CssClass="form-control" />增加后缀     
            ...
            <div class="form-inline">
                <div class="form-group mr20">
                    <label for="sellshop4">查找字符串：</label>
                    <asp:TextBox ID="txtOleWord" runat="server" Width="80px" CssClass="form-control" />替换成
                                  <asp:TextBox ID="txtNewWord" runat="server" Width="80px" CssClass="form-control" />
                </div>
        ...
        <div class="form-group">
            <div class="col-xs-offset-4 col-xs-10">
                ...
                <asp:Button ID="btnSaveInfo" runat="server"   Text="保存设置" CssClass="btn btn-default" />
