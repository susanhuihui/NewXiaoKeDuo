...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        ...
        #ctl00_ContentPlaceHolder1_dlstPtReviews td {margin:0px;border-left:0px;border-right:0px;vertical-align:middle;}
            ...
            <div class="tab-content">
                <div class="tab-pane active">
                    ...
                    <UI:Grid ID="dlstPtReviews" runat="server" ShowHeader="true" CssClass="table mar table-bordered" AutoGenerateColumns="false" DataKeyNames="ReviewId" HeaderStyle-CssClass="table_title"   GridLines="None" Width="100%">
                        <Columns>
                            <asp:TemplateField SortExpression="ProductName" ItemStyle-Width="30%" HeaderText="商品" HeaderStyle-CssClass="td_right td_left">
                            ...
                            <asp:TemplateField HeaderText="操作" ItemStyle-Width="10%" HeaderStyle-CssClass="td_left td_right_fff">
                                <ItemTemplate>
                                    <span class="submit_shanchu">
                                        <Hi:ImageLinkButton ID="btnReviewDelete" runat="server" CommandName="Delete" IsShow="true" CommandArgument='<%# Eval("ReviewId")%>' Text="删除" CssClass="btn btn-danger resetSize" />
                                    </span>
                                </ItemTemplate>
                            </asp:TemplateField>
