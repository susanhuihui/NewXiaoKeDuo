    ...
    <div class="form-horizontal" id="FormAttributeValue">
        <div id="valueStr" runat="server">
            <div class="form-group" style="height: 30px;">
                ...
                <div class="col-xs-8">
                    <asp:textbox id="txtValueStr" cssclass="form-control"   runat="server" onkeydown="javascript:this.value=this.value.replace('，',',')" />
                </div>
                
            </div>
             <small class="help-block" style="margin-left:100px;">多个规格值可用“,”号隔开，每个值的字符数最多15个字符</small>
        </div>
        <div id="valueImage" runat="server" visible="false">
         ...
         <div class="form-group">
                <div class="col-xs-offset-2 col-xs-10">
                    <asp:button id="btnCreateValue" runat="server" text="确 定" class="btn btn-default" />
