    ...
    <form runat="server" id="aspForm">
                <div class="shopuser clearfix">
                    <div class="fl shopuser-img clearfix">
                        <div class="img fl">
                            <img src="http://fpoimg.com/80x80" runat="server" id="imgLogo">
                        </div>
                ...
                <div class="shopdatatable clearfix">
                    <div class="shopdatatable-left fl">
                        <table class="table table-hover">
                            <caption>分销商佣金排名<p><%--<span class="active">7天</span><span>30天</span></p>--%></caption>
                            <thead>
                                <tr>
                                    <th>店铺名称</th>
                                    <th>销售订单数</th>
                                ...
                                <asp:Repeater ID="rptDistributor" runat="server" >
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%# Convert.ToDecimal(Eval("SumCommission")).ToString("N2") %></td>
                                            <td><%# Eval("Rank")%></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                    ...
                    <div class="shopdatatable-right fr">
                        <table class="table">
                            <caption>会员消费排名<%--<p><span class="active">7天</span><span>30天</span></p>--%></caption>
                            <thead>
                                <tr>
                                <th>会员名</th>
                                <th>购买订单数</th>
