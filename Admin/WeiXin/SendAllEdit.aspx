    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(".typeList li").click(function () {
                ...
                switch (typeval) {
                    ...
                    default:                        
                        ...
                        $(".mobile.mate-list").html("<div class=\"exit-shop-info\">" +removeHTMLTag(um.getContent()) + "</div>");
                        $("#divContent").show();
                        break;
                }
            });
            ...
            um.addListener('ready', function (editor) {
                $(".exit-shop-info").html(removeHTMLTag(um.getContent()));
            });
            ...
            $("#btnWeiXinSend,#btnKefuSend").click(function(){
                ...
                var content=removeHTMLTag(um.getContent());
