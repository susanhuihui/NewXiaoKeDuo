...
<%--                <ul class="nav nav-tabs">
                    <li class="active"><a href="javascript:;"><%=htmlMenuTitleAdd %>图文</a></li>
                </ul>--%>
                <!-- Tab panes -->
                ...
                <asp:Repeater ID="rptList" runat="server"  >
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%# Eval("PubTime") %></td>
                            <td> <button type="button" class="btn btn-default" value='<%#Eval("Url") %>' onclick="gotovalue('<%#Eval("ArticleId") %>')">选取</button>
</td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
