...
<%--                            <input type="button" class="btn btn-success resetSize" value="批量发货" onclick="SetLogisticsOrSendGoods(1)" />--%>&nbsp;︱
                            ...
                            <asp:Button ID="btnDeleteCheck" Visible="false" runat="server" Text="批量删除" CssClass="btn btn-danger resetSize" OnClientClick="return HiConform('<strong>订单删除后将不可恢复！</strong><p>确定要批量删除所选择的订单吗？</p>',this)" />
                        </div>
                    </div>
                </div>
                <div class="page fr">
                                ...
                                <div class="listTitle">
                                    ...
                                    <span class="ok">
                                        <Hi:OrderStatusLabel ID="lblOrderStatus" OrderStatusCode='<%# Eval("OrderStatus") %>'
                                            runat="server" /></span><span class="ml10 logistics" tid="<%#Eval("ExpressCompanyAbb") %>"><%--物流公司：未指定--%></span>
