...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="padding: 15px; width: 30%; vertical-align: middle;">
                                    ...
                                    <p class="mb5"><span>退款金额：</span><i style="color: red; font-weight: bold; font-style: normal;">￥<asp:Literal ID="litRefundMoney" runat="server"></asp:Literal><%#Eval("RefundMoney","{0:F2}") %></i><%--<a href="#" class="ml5">修改</a>--%></p>
                                </td>
                                <td style="border-left: 1px solid #ccc; padding: 15px; vertical-align: middle; width: 395px;">
                                    ...
                                    <p>
                                        <input type="button" class="btn btn-success btn-sm inputw100" value="同意退款" id="btnAgree" runat="server" productid='<%#Eval("productid") %>' money='<%#Eval("RefundMoney","{0:F2}") %>' onclick="AgreeReturnFun($(this).attr('productid'),$(this).attr('money'))" />
                                        <input type="button" class="btn btn-danger btn-sm inputw100" value="拒绝退款" id="btnRefuce" runat="server" productid='<%#Eval("productid") %>' onclick="RefuseReturnFun($(this).attr('productid'))" />
                ...
                <div role="tabpanel" class="tab-pane" id="profile">
                    <div class="set-switch">
                        ...
                        <div id="pLoginsticInfo" runat="server" class="row" visible="false">
                            ...
                            <span id="expressInfo" class="col-xs-10" style="color:#C60">正在加载中....</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        /*同意退款*/
        function AgreeReturnFun(productid,money){
        ...
        /*拒绝退款*/
        function RefuseReturnFun(productid){
            $("#ctl00_ContentPlaceHolder1_hdProductID").val(productid);
