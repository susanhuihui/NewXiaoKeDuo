                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <asp:Repeater ID="rptItemList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td title="<%#Eval("ShippingRegion").ToString()+", "+Eval("Address").ToString() %>"><%#Eval("ShipTo") %></td>
        ...
        <div style="width: 100%">
            <div class="InputShow">
                ...
                <asp:Panel runat="server" ID="pnlEmptySender">
                    <span><a href="../Settings/shippers.aspx" target="_parent">您还没有添加发货人信息，请先点击这里添加发货人信息!</a></span>
                </asp:Panel>
