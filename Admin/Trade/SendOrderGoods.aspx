                                            ...
                                            <asp:Repeater ID="rptItemList" runat="server">
                                                <ItemTemplate>
                                                    <div class="orderInfolist clearfix">
                                                        <span style="width: 125px; display: inline-block;"><%#Eval("ShipTo") %></span>
                                                        ...
                                                        <span style="width: 138px; display: inline-block;">
                                                            <input type="text" name="shipordernumber" style="width: 125px;" value="<%#Eval("ShipOrderNumber") %>" title="快递单号" maxlength="20" onkeyup="value=value.replace(/[\W]/g,'')" />
                                                        </span>
