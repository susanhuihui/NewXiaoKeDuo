                ...
                <div class="form-horizontal fl">
                    <div class="form-group mar forced">
                        <div class="checkbox">
                            ...
                            <asp:Button ID="btnDeleteCheck" runat="server" Text="批量删除" CssClass="btn btn-danger resetSize" OnClientClick="return HiConform('<strong>订单删除后将不可恢复！</strong><p>确定要批量删除所选择的订单吗？</p>',this)" />
                        </div>
                    </div>
                </div>
                <div class="page fr">
                                ...
                                <div class="listTitle">
                                    ...
                                    <span class="ok">
                                        <Hi:OrderStatusLabel ID="lblOrderStatus" OrderStatusCode='<%# Eval("OrderStatus") %>'
                                            runat="server" /></span><span class="ml10 logistics" tid="<%#Eval("ExpressCompanyAbb") %>" oid="<%#Eval("OrderID") %>" shipnum="<%#Eval("ShipOrderNumber") %>"><%--物流公司：未指定--%></span>
