                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td style="text-align: center; width: 23%;">
                                        <button type="button" onclick='<%#string.Format("window.location.href=\"EditProductToExchange.aspx?id={0}\"", Eval("id"))%>' class="btn btn-warning btn-sm" name="updateBtn" <%#string.Format("{0}", Eval("canChkStatus"))%>>
                                            修改商品                                            
                                        </button>
                                        ...
                                        <span class="submit_jiage" style="margin-left:10px;">
                                            <a href="PointExchange.aspx?id=<%#Eval("id")%>" name="edit">编辑</a>
                                        </span>
                                        <span class="submit_jiage" style="margin-left:10px;">
