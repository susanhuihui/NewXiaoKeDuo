...
.Regions,.tdleft{text-align:left!important;padding-left:15px}
.borderleft{border-left:1px solid #ddd}
.pinfo{margin:5px 20px;color:#4896f6}
     ...
     .Dstatus .btn{margin-bottom:5px}
      #ddlRegions1,#ddlRegions2{margin-right:3px}
      .splittr{border:0px!important}
      .addwauto{width: auto!important;display:inline-block!important}
</style>
    <script>
        ...
        $(function () {
            ...
            $(".viewinfo").click(function () {
                ...
                window.location.href = "PrizeDeliveryDetail.aspx?LogId=" + LogId;
            })
        ...
        <div class="modal-body form-horizontal" >
            ...
            <div class="form-group">
             ...
             <div class="form-group  form-horizontal">
                        ...
                        <div class="col-xs-9 ">
                        <iframe id="addressRegion" width="100%" height="30px" scrolling="no" frameborder=0 style="overflow:hidden;padding-top:3px;border:0px" src="hiRegionSelect.aspx">
                ...
                <div class="tab-pane active">
                    ...
                    <div class="set-switch">
                        <div class="form-inline mb10">
                            ...
                            <div class="form-group mr20">
                                <label for="sellshop2">　成交时间：</label>
                                <div class="form-group">
                        ...
                        <div class="reset-search" style="right: 150px">
                    ...
                    <div class="form-inline" style="margin-bottom: 10px; margin-top:-10px;">
                        <input type="checkbox" id="sells1" class="allselect" onclick="SelectAllNew(this)"> 全选
                        <input type="button" value="批量删除" class="btn resetSize btn-danger" onclick="DelSel()" />                         
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="rows_title">
                                        <th class="tdleft" width="25%">&nbsp;&nbsp;
                                            ...
                                            中奖编号：<%# Eval("PlayTime","{0:yyyyMMdd}")%>-<%# Eval("PrizeGrade") %>-<%# Eval("LogId")%></th>
                                         <th class="tdleft" width="20%">
                                            <%# Eval("PlayTime","{0:yyyy-MM-dd hh:mm:ss}")%>
                                        </th>
                                         <th  width="10%" style="color:#ed4e1a">
                                            <%# GameHelper.GetPrizesDeliveStatus(Eval("status").ToString())%>
                                        </th>
                                         <th  width="10%"> </th><th class="tdleft" width="15%"> </th> 
                                    </tr>
                                    <tr>
                                        <td class="tdleft">
                                            ...
                                            <div class="pinfo"><%#Eval("ProductName") %></div>
                                        </td>
                                         <td class="tdleft">
                                            <%#Eval("GameTitle") %><br />
                                            <span class="jpname">
                                                [<%# GameHelper.GetGameTypeName(Eval("GameType").ToString()) %>]</span>
                                        </td>
                                         <td class="borderleft" >
                                            <%# Eval("Receiver")==DBNull.Value?Eval("RealName"):Eval("Receiver")%><br />
                                             <%# Eval("Tel")==DBNull.Value?Eval("CellPhone"):Eval("Tel") %>
                                        </td>
                                         <td >
                                     ...
                                     <tr class="splittr"><td colspan="5"　></td></tr>
