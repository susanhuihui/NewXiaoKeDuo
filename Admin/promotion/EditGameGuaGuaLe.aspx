                    ...
                    <div class="mobile-d">
                        ...
                        <div class="set-overflow">
                            <div class="white-box resetH" style="background-color: #FF3B3C;">
                                <div class="topimg" style="background: url(../images/guajiangpic1.png) no-repeat;
                                    background-size: 100%; width: 276px; height: 177px; margin: 0 auto;">
                                </div>
                                <div class="gamePrizes">
                                    <h3>活动奖品：</h3>
                                    <p>
                                        <span>一等奖：<span id="sPrizeGade0"><asp:Label ID="lbPrizeGade0" runat="server" Text=""></asp:Label></span></span>
                                        <span>二等奖：<span id="sPrizeGade1"><asp:Label ID="lbPrizeGade1" runat="server" Text=""></asp:Label></span></span>
                                    </p>
                                    <p>
                                        <span>三等奖：<span id="sPrizeGade2"><asp:Label ID="lbPrizeGade2" runat="server" Text=""></asp:Label></span></span>
                                        <span>四等奖：<span id="sPrizeGade3"><asp:Label ID="lbPrizeGade3" runat="server" Text=""></asp:Label></span></span>
                                    </p>
                                </div>
                                <div class="gamePrizes">
                                    <h3>活动说明：</h3>
                                ...
                                <div class="bottomimg" style="background: url(../images/guaguakapic.png) no-repeat;
