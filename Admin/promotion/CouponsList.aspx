    ...
    <script type="text/javascript">
        ...
        function useCoupon(obj, couponId, flag) {
            if (flag.toLowerCase() == "false") {
                ...
                if (HiConform("1、启用优惠券，是否继续？ \n 2、优惠券已过期，重新设定有效期？", obj)) {
                    //弹出修改窗体                    
                ...
                <div class="tab-pane active">
                     <div style="margin-top:10px;">
                        ...
                        <div class="form-inline" id="searchDiv">
                         ...
                         <div class="form-inline" style="margin-bottom: 10px; margin-top:-10px; display:none;" id="operateDiv">
                        ...
                        <UI:Grid ID="grdCoupondsList" runat="server" ShowHeader="true" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                <UI:CheckBoxColumn CellWidth="50" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" />
                                ...
                                <asp:TemplateField HeaderText="使用期限" ShowHeader="true" HeaderStyle-Width="150" ItemStyle-Width="150">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <%# Eval("BeginDate")%> 至 
                                        <%# Eval("EndDate")%>
                                ...
                                <asp:TemplateField HeaderText="领取限制" ShowHeader="true">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <%# Eval("ReceivNum")%>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="库存" ShowHeader="true">
                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <%# Eval("StockNum")%>张
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="border_top border_bottom" HeaderStyle-Width="250">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <span stitle="unFinishSpan" class="submit_jiage" style="display:none;"> 
                                            <asp:LinkButton runat="server" ID="unFinishBtn" OnClientClick='<%#string.Format("return useCoupon(this, \"{0}\",\"{1}\")", Eval("CouponId"),Eval("expire"))%>' CssClass="btn btn-success resetSize" CommandName="Update" Text="启用"></asp:LinkButton>
                                        </span>

                                        <span stitle="modifyProductSpan" class="submit_jiage" style="display:none;">
                                            <a href='<%# Globals.GetAdminAbsolutePath(string.Format("/promotion/EditProductToCoupon.aspx?id={0}", Eval("CouponId")))%>')">修改商品</a>
                                        </span>
