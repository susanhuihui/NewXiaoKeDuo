                ...
                <UI:Grid ID="grdPrizeLists" runat="server" ShowHeader="true" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="奖品" ShowHeader="true">
                            <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <%# Hidistro.ControlPanel.Promotions.GameHelper.GetPrizeName(new Hidistro.Entities.Promotions.PrizeResultViewInfo(){ PrizeType=(Hidistro.Entities.Promotions.PrizeType)int.Parse(Eval("PrizeType").ToString()), GivePoint=int.Parse(Eval("GivePoint").ToString()), GiveCouponId=Eval("GiveCouponId").ToString(), GiveShopBookId=Eval("GiveShopBookId").ToString() }) %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="中奖时间" ShowHeader="true">
                            ...
                            <ItemTemplate>
                                <%# Eval("PlayTime","{0:yyy-MM-dd HH:mm}")%>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </UI:Grid>
