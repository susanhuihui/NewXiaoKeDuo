                        ...
                        <div class="set-overflow">
                            <div class="white-box resetH">
                                ...
                                <div class="gamePrizes">
                                    <h3>活动奖品：</h3>
                                    <p>
                                        <span><span id="sPrizeGade0"><asp:Label ID="lbPrizeGade0" runat="server" Text=""></asp:Label></span></span>
                                        <span><span id="sPrizeGade1"><asp:Label ID="lbPrizeGade1" runat="server" Text=""></asp:Label></span></span>
                                    </p>
                                    <p>
                                        <span><span id="sPrizeGade2"><asp:Label ID="lbPrizeGade2" runat="server" Text=""></asp:Label></span></span>
                                        <span><span id="sPrizeGade3"><asp:Label ID="lbPrizeGade3" runat="server" Text=""></asp:Label></span></span>
                                    </p>
                                </div>
                                <div class="gamePrizes">
                                    <h3>活动说明：</h3>
                                    <p id="pGameDescription"><asp:Label ID="lbGameDescription" runat="server" Text=""></asp:Label></p>
                                </div>
                                <div class="gamePrizes">
                                    <h3>活动时间：</h3>
                                    <p>
                                        <span id="sBeginTime"><asp:Label ID="lbBeginTime" runat="server" Text=""></asp:Label></span>至 <span id="sEedTime">
