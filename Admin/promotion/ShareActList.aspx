                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td  title="controls" style="text-align: center; width: 20%;">
                                            ...
                                            <asp:Button ID="lkDelete" runat="server" Text="删除" CommandName="Delete" CssClass="btn btn-danger resetSize" OnClick="lkDelete_Click" OnClientClick='<%# string.Format("return del({0});",Eval("Id"))%>' ToolTip="" />  
                                        </td>
                                    </tr>
