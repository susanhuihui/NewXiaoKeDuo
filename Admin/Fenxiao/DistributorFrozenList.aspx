                    ...
                    <div class="set-switch">
                        <div class="form-inline mb10">
                            ...
                            <div class="form-group mr20">
                                ...
                                <asp:TextBox ID="txtRealName"  CssClass="form-control resetSize inputw100" runat="server" 
                                    Width="150" />
                            </div>
                        ...
                        <div class="reset-search" style="margin-left:10px">
                    ...
                    <div class="sell-table">
                        <div class="title-table">
                            <table class="table">
                             ...
                             <Hi:ImageLinkButton ID="UnFrozenCheck" class="btn resetSize btn-primary" runat="server" Text="批量解冻" IsShow="true"  DeleteMsg="确定解冻分销商？"/>
                                                <button type="button" class="btn resetSize btn-primary" onclick="ShowGrade()">批量设置等级</button>
                                                &nbsp;&nbsp;︱
                                                <button type="button" class="btn resetSize btn-primary" onclick="ShowPassword()">设置密码</button>
                                                <Hi:ImageLinkButton ID="CancleCheck" class="btn resetSize btn-primary" runat="server" Text="取消分销资质" IsShow="true"  DeleteMsg="确定取消分销商资质，取消后不可恢复！"/>
  &nbsp;&nbsp;
                        ...
                        <div class="content-table">
                            <table class="table">
                                <tbody>
                                    ...
                                    DeleteMsg="确定解冻分销商？"  title="冻结以后，分销商不能进入分销管理中心，期间也不会获得佣金。" />
                                                    </p>
                                                   <p>
