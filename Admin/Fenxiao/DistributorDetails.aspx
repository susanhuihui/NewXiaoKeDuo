          ...
          <div class="set-switch clearfix">
              <div class="infodiv">
                ...
                <div class="infodiv infosdetail infosdetailLong"　>
                    <ul>
                        <li>
                            <label>店铺名：</label><span id="txtStoreName" runat="server">-</span>　　　　　　　　　　　　　　　　　　<a id="copybutton" data-clipboard-target="ctl00_ContentPlaceHolder1_txtUrl" style="cursor:pointer;color:#808080">复制链接</a></li>
                        <li>
