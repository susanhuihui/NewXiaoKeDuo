    ...
    <script>
        ...
        function submitaddandedit() {
            if ($.trim($("#txttitle").val()) == "") {
                HiTipsShow("请输入标题内容！", 'warning');
                return;
            }
            if ($.trim($("#txtContent").val()) == "") {
                HiTipsShow("请填写标题回复内容！", 'warning');
                return;
            }
            ...
            if (andedit == 0) {//添加一级和二级菜单
                var url = "&ParentMenuId=" + parentid + "&Name=" + $("#txttitle").val() + "&Content=" + $("#txtContent").val() + "&Type=" + Type + "";
            ...
            {
                var url = "&ParentMenuId=" + parentid + "&MenuId=" + editid + "&Name=" + $("#txttitle").val() + "&Content=" + $("#txtContent").val() + "&Type=" + Type + "";
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="content" class="col-xs-2 control-label">回复内容</label>
                            <div class="col-xs-5">
