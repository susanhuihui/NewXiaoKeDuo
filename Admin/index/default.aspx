<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminNew.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Hidistro.UI.Web.Admin.index._default" %>
...
<div class="hishop_list_content">
    <div class="hishop_list_l">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="td_cont_left">当前版本</td><td class="sp_img">V3.0</td>
            </tr>
            </table>
    ...
    <div class="hishop_list_r">
             <div class="hishop_contenttitle">销客多动态</div>
             
            
          <div class="hishop_list_tab">
              <div style="height:370px;">
              <Hi:HiControls LinkURL="http:\\www.hishop.com.cn/efx01/vshop.html" runat="server" Height="370" ID="HiControlsId"/>              
            </div>
            <iframe src="http://www.hishop.com.cn/efx01/vstj.html"  frameborder="0" width="100%"></iframe>
          </div>
    </div>
</div>
</asp:Content>
