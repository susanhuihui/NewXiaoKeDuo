    ...
    <asp:Repeater ID="rptCartProductItems" runat="server" DataSource='<%# Eval("LineItems") %>'>
        <ItemTemplate>
            ...
            <div class="panel-body goods-list-p">
                <a href="<%# Globals.ApplicationPath + "/ProductDetails.aspx?productId=" + Eval("ProductId")%>" class="detailLink">
                    <div class="box">
                        <div class="left">
                        ...
                        <div class="right">
                            ...
                            <div class="price text-danger">
                                ...
                                <%# Eval("Type").ToString()=="0"?"￥"+Eval("AdjustedPrice", "{0:F2}"):Eval("PointNumber")+"积分"%><span class="bcolor"> x
                    <%# Eval("Quantity")%></span>  
                            </div>
...
<div style="  text-align: right; ">
    <div class="last">
        ...
        <p class="">
            商品金额：¥<span id='goodsmenoy<%# Eval("TemplateId") %>'><%#Eval("Total", "{0:F2}") %></span>
        </p>
        <p class="">
